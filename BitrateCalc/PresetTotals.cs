...
namespace BitrateCalc
{
    public class PresetSize
    {
        ...
        {            
            ...
            new PresetSize("1/2 DVD (2241MB)", 2241L * 1024L * 1024L),
            ...
            new PresetSize("1.5x DVD (6723MB)", 6723L * 1024L * 1024L),
            new PresetSize("1 DVD-9 (8152MB)", 8152L * 1024L * 1024L),
            new PresetSize("1 BD (23450MB)", 23450L * 1024L * 1024L), // actual is 25025314816 bytes
            new PresetSize("1 BD-50 (46900MB)", 46900L * 1024L * 1024L) // actual is 7791181824 bytes
        };
